...
class Jpg(object):
    """Jpg is a library for exploring data and python concepts
    The first method is to create a jpg file from a data array
    ...
    def __init__(self):
        """Return a Jpg object whose name is *name* and starting
        """

    def pl_create_jpg(self, fname, array_name, cmap='prism', 
